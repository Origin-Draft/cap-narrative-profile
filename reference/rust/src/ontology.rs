...
pub fn core_primitives() -> Vec<OntologyPrimitive> {
    ...
    primitives.extend([
        vocab_term(
            ...
            "enums::Archetype",
            "archetype",
            "02-characters/references/character-archetypes.yaml",
        ),
        vocab_term(
            "vocab.wound",
            ...
            "enums::Wound",
            "wound",
            "02-characters/references/character-wounds.yaml",
        ),
        vocab_term(
            "vocab.drive_model",
            ...
            "enums::DriveModel",
            "drive_model",
            "02-characters/references/character-drives.yaml",
        ),
        vocab_term(
            "vocab.arc_type",
            "Character arc type",
            "enums::ArcType",
            "arc",
            "02-characters/references/character-arc-types.yaml",
        ),
        vocab_term(
            "vocab.actant",
            ...
            "enums::Actant",
            "actant",
            "02-characters/cross-refs/actantial-map.md",
        ),
        vocab_term(
            "vocab.genre",
            "Story genre",
        ...
        vocab_term(
            ...
            "enums::PlotType",
            "plot_type",
            "04-plot-and-structure/references/plot-types.yaml",
        ),
        vocab_term(
            ...
            "collision_pattern",
            "01-concept/collision/references/collision-patterns.yaml",
        ),
        vocab_term(
            ...
            "enums::TemporalOrder",
            "temporal_order",
            "04-plot-and-structure/references/narrative-time-reference.md",
        ),
        vocab_term(
            "vocab.reader_effect",
            ...
            "reader_effect",
            "04-plot-and-structure/reader-experience/reader-experience-map.md",
        ),
        vocab_term(
            ...
            "enums::DiegeticLevel",
            "diegetic_level",
            "04-plot-and-structure/architecture/frame-narrative.md",
        ),
    ]);
    ...
    primitives.push(OntologyPrimitive {
        ...
        projections: vec![
            ...
            PrimitiveProjection {
                projection_type: ProjectionType::MarkdownTag,
                target: "05-drafting/voice-contract/".to_owned(),
                aliases: vec![],
            },
        ],
    });
