...
use crate::entities::{Character, Scene, Setting, Motif};
use crate::enums::{Act, DominantSense, MotifStage, RevisionFlag};
use crate::tags::{AnnotationChannel, EntityRef, ParagraphAnnotations, SentenceAnnotations};
use crate::voice::{DialogueSegment, FocalizationConfig, VoiceContract, VoiceSignature};
...
pub struct CharacterState {
    ...
    pub dominant_drive: Option<crate::enums::DriveModel>,
