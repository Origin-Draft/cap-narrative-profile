...
py_enum!(PyArchetype, crate::enums::Archetype, Hero, Mentor, Trickster, Lover, Caregiver, Sage, Innocent, Rebel, Ruler, Creator, Explorer, Magician, Jester, Outlaw);
py_enum!(PyWound, crate::enums::Wound, Abandonment, Betrayal, GuiltAndFailure, TraumaAndAbuse, Shame, Grief, TrustViolation, Powerlessness, IdentityRejection, Injustice, Neglect, SurvivorGuilt, Displacement);
py_enum!(PyAlignment, crate::enums::Alignment, LawfulGood, NeutralGood, ChaoticGood, LawfulNeutral, TrueNeutral, ChaoticNeutral, LawfulEvil, NeutralEvil, ChaoticEvil);
py_enum!(PyRole, crate::enums::Role, Protagonist, Deuteragonist, Antagonist, LoveInterest, Mentor, Confidant, Foil, Trickster, Guardian, Herald, Shapeshifter, Contagonist, WalkOn);
py_enum!(PyDriveModel, crate::enums::DriveModel, Wound, Desire, Duty, Perception, Existential);
py_enum!(PyGateStatus, crate::enums::GateStatus, Green, Yellow, Red, Locked, Unknown);
py_enum!(PySubPhaseStatus, crate::enums::SubPhaseStatus, Locked, Ready, InProgress, Complete);
py_enum!(PyPhaseStatus, crate::enums::PhaseStatus, Green, Yellow, Red, Unknown);
py_enum!(PyRevisionFlag, crate::enums::RevisionFlag, TellingNotShowing, VoiceContractFail, PivotUnclear, SubtextMissing, PacingDrag, ContinuityBreak);

// ── EntityRef ─────────────────────────────────────────────────────────────────

#[pyclass]
pub struct PyEntityRef {
    inner: crate::tags::EntityRef,
}
...
impl PyEntityRef {
    ...
    fn new(slug: &str) -> Self {
        Self { inner: crate::tags::EntityRef::new(slug) }
    }
    #[getter]
...
#[pyclass]
pub struct PyCharacter { inner: crate::entities::Character }
json_methods!(PyCharacter, crate::entities::Character);
...
impl PyCharacter {
    ...
    fn new(id: &str, name: &str) -> Self {
        Self {
            inner: crate::entities::Character {
                id: id.to_owned(),
                name: name.to_owned(),
                slot: None,
                archetype: None,
...
#[pyclass]
pub struct PyScene { inner: crate::entities::Scene }
json_methods!(PyScene, crate::entities::Scene);
...
#[pyclass]
pub struct PyVoiceSignature { inner: crate::voice::VoiceSignature }
json_methods!(PyVoiceSignature, crate::voice::VoiceSignature);
...
impl PyVoiceSignature {
    ...
    fn new(character_id: &str) -> Self {
        Self {
            inner: crate::voice::VoiceSignature {
...
#[pyclass]
pub struct PyVoiceContract { inner: crate::voice::VoiceContract }
json_methods!(PyVoiceContract, crate::voice::VoiceContract);

#[pymethods]
impl PyVoiceContract {
    #[new]
    fn new() -> Self {
        Self { inner: crate::voice::VoiceContract::default() }
    }
}
...
fn parse_annotation(
    ...
    let (anns, warns) = crate::tags::parse_annotation_comment(raw);
