...
fn parse_annotated_paragraphs(
    content: &str,
    min_words: u32,
) -> Vec<(Vec<grimoire_types::tags::Annotation>, String)> {
    let mut blocks: Vec<(Vec<grimoire_types::tags::Annotation>, String)> = Vec::new();
    let mut in_frontmatter = false;
    let mut pending_anns: Vec<grimoire_types::tags::Annotation> = Vec::new();
...
fn flush_block(
    para_buf: &mut String,
    pending_anns: &mut Vec<grimoire_types::tags::Annotation>,
    blocks: &mut Vec<(Vec<grimoire_types::tags::Annotation>, String)>,
    min_words: u32,
) {
